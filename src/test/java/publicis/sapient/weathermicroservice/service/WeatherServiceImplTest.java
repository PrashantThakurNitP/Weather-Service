...
class WeatherServiceImplTest {
    ...
    void testGetWeatherForCity_Success() throws NotFoundException, UnAuthorizedException, InternalServerError {
        ...
        assertEquals(MESSAGE_FOR_NICE_WEATHER, result.get(1).getMessage());
        assertEquals(MESSAGE_FOR_NICE_WEATHER, result.get(2).getMessage());
    ...
    private WeatherApiResponse createMockWeatherApiResponse() {
        ...
        WeatherData weatherData4 = WeatherData.builder().dt_txt("21-04-1995 12:00:00").main(MainData.builder().temp(291).temp_min(275).temp_max(300).build()).weather(List.of(WeatherDescription.builder().description("Cloudy").icon("01").main("main").id(201).build())).wind(WindData.builder().speed(6.0).build()).build();//thunderstorm
        WeatherData weatherData5 = WeatherData.builder().dt_txt("21-04-1995 15:00:00").main(MainData.builder().temp(290).temp_min(275).temp_max(300).build()).weather(List.of(WeatherDescription.builder().description("Cloudy").icon("01").main("main").id(501).build())).wind(WindData.builder().speed(9.0).build()).build();//rain
        WeatherData weatherData6 = WeatherData.builder().dt_txt("21-04-1995 18:00:00").main(MainData.builder().temp(273).temp_min(275).temp_max(300).build()).weather(List.of(WeatherDescription.builder().description("Cloudy").icon("01").main("main").id(401).build())).wind(WindData.builder().speed(9.0).build()).build();//low temp
