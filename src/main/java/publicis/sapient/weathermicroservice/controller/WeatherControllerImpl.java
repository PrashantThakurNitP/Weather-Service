...
public class WeatherControllerImpl implements WeatherController {
    ...
    public ResponseEntity<List<WeatherResponse>> getWeatherForecast(@RequestParam String cityName,@RequestParam @Min(1) int days) throws NotFoundException, UnAuthorizedException, InternalServerError {
